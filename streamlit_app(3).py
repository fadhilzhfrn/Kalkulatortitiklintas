...
menu = st.sidebar.radio('Pilih Menu', ['Selamat Datang', 'Pengertian Titik Sampling', 'Penjelasan Baku Mutu', 'Perhitungan dan Hasil'])
...
if menu == 'Selamat Datang':
    bold_black_header('Selamat Datang'"\N{factory}")
    st.write(
        """\
    ...
    st.write(
        ...
        Secara umum, titik sampling harus didistribusikan secara merata pada penampang cerobong dan pada area yang mewakili 
        aliran gas di cerobong. Pemilihan titik sampling yang tepat sangat penting untuk mendapatkan hasil yang akurat dan dapat diandalkan.
        """
    )
    ...
    st.write(
        ...
        1. Jumlah Titik Sampling:
            ...
            - Diameter > 10 m: 8 titik (atau lebih sesuai kebutuhan teknis)
        
        2. Distribusi Titik Sampling:
            - Titik-titik sampling harus didistribusikan pada posisi yang mewakili aliran gas di seluruh penampang cerobong.
            - Titik-titik tersebut biasanya ditempatkan pada jarak yang sama di seluruh penampang cerobong.
        
        3. Jarak Antar Titik Sampling:
            - Jarak antar titik sampling ditentukan berdasarkan diameter cerobong dan jumlah titik sampling.
            - Jarak harus cukup untuk mendapatkan data yang representatif dan tidak saling tumpang tindih.
        
        4. Ketinggian Pengambilan Sampel:
            - Titik sampling pada cerobong harus diambil pada ketinggian yang mewakili aliran gas secara keseluruhan.
            - Biasanya tidak lebih dari 1/3 atau 1/2 dari tinggi cerobong.
        
        5. Standar Prosedur Pengambilan Sampel:
            - Prosedur pengambilan sampel harus mengikuti pedoman teknis yang tercantum dalam SNI 7117.13:2009 untuk memastikan akurasi dan konsistensi hasil pengukuran.
            - Pengambilan sampel harus dilakukan dengan peralatan yang memenuhi standar dan dioperasikan oleh personel yang terlatih.
        """
    )
